...
MACRO_CONFIG_INT(LandyCustomAspect, landy_custom_aspect, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable custom internal render resolution")
MACRO_CONFIG_INT(LandyCustomAspectWidth, landy_custom_aspect_width, 1701, 640, 7680, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Custom internal render width")
MACRO_CONFIG_INT(LandyCustomAspectHeight, landy_custom_aspect_height, 1080, 480, 4320, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Custom internal render height")
MACRO_CONFIG_INT(LandyCustomAspectPreset, landy_custom_aspect_preset, 0, 0, 6, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Custom render resolution preset")
MACRO_CONFIG_INT(LandyCustomAspectAppliedWidth, landy_custom_aspect_applied_width, 1701, 640, 7680, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Applied custom render width")
MACRO_CONFIG_INT(LandyCustomAspectAppliedHeight, landy_custom_aspect_applied_height, 1080, 480, 4320, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Applied custom render height")
MACRO_CONFIG_INT(LandyCustomAspectGameOnly, landy_custom_aspect_game_only, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Apply custom aspect ratio only to the game world")

// Landy Input
// Input mode: 0 = TClient, 1 = Landy, 2 = Amadeus+, 3 = Sasuke+
MACRO_CONFIG_INT(LandyFastInputMode, landy_fast_input_mode, 0, 0, 3, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Input mode: 0=TClient, 1=Landy, 2=Amadeus+, 3=Sasuke+")
// Precision Input: resolves simultaneous left+right key presses by tracking last pressed direction
MACRO_CONFIG_INT(LandyPrecisionInput, landy_precision_input, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable precision input (last-pressed direction priority for simultaneous inputs)")
// Precision Input tuning sliders (0-100, default 50)
MACRO_CONFIG_INT(LandyInputSharpness, landy_input_sharpness, 50, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Precision input sharpness (reserved for future tuning)")
MACRO_CONFIG_INT(LandyHorizStrength, landy_horiz_strength, 50, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Horizontal input strength for precision input (reserved for future tuning)")

// Amadeus+ Input (fast input with sharp-but-smoothed render correction)
MACRO_CONFIG_INT(LandyAmadeusPlus, landy_amadeus_plus, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable Amadeus+ fast input")
MACRO_CONFIG_INT(LandyAmadeusAmount, landy_amadeus_amount, 140, 100, 500, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Amadeus+ prediction amount in 0.01 ticks (100-500)")
MACRO_CONFIG_INT(LandyAmadeusCorrection, landy_amadeus_correction, 75, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Amadeus+ render correction sharpness (0-100%)")
MACRO_CONFIG_INT(LandyAmadeusOthers, landy_amadeus_others, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Apply Amadeus+ fast input to other tees")

// Sasuke+ Input (fast input with soft ice-like render correction)
MACRO_CONFIG_INT(LandySasukePlus, landy_sasuke_plus, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable Sasuke+ fast input")
MACRO_CONFIG_INT(LandySasukeAmount, landy_sasuke_amount, 100, 100, 500, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Sasuke+ prediction amount in 0.01 ticks (100-500)")
MACRO_CONFIG_INT(LandySasukeCorrection, landy_sasuke_correction, 30, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Sasuke+ render correction softness (0-100%)")
MACRO_CONFIG_INT(LandySasukeOthers, landy_sasuke_others, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Apply Sasuke+ fast input to other tees")
...
MACRO_CONFIG_INT(TcTranslateAutoIncoming, tc_translate_auto_incoming, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable automatic translation of incoming chat messages")
...
MACRO_CONFIG_STR(BcTranslateIncomingIgnoreLanguages, bc_translate_incoming_ignore_languages, 128, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Semicolon-separated source languages that should not be auto-translated, e.g. ru; en")
