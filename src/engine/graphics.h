...
public:
	...
	{
		if(g_Config.m_LandyCustomAspectPreset != 0 && g_Config.m_LandyCustomAspectAppliedHeight > 0)
			return g_Config.m_LandyCustomAspectAppliedWidth / (float)g_Config.m_LandyCustomAspectAppliedHeight;
