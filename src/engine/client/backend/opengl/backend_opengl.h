...
protected:
	...
	bool m_IsOpenGLES;
	TWGLuint m_CustomRenderFbo = 0;
	TWGLuint m_CustomRenderTexture = 0;
	int m_CustomRenderWidth = 0;
	int m_CustomRenderHeight = 0;
	int m_WindowViewportWidth = 0;
	int m_WindowViewportHeight = 0;
	bool m_CustomRenderActive = false;

	void UpdateCustomRenderTarget();
	void DestroyCustomRenderTarget();
