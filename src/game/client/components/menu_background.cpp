...
std::array<vec2, CMenuBackground::NUM_POS> GenerateMenuBackgroundPositions()
{
	...
	Positions[CMenuBackground::POS_SETTINGS_TCLIENT] = vec2(0.0f, 0.0f);
	Positions[CMenuBackground::POS_SETTINGS_LANDY] = vec2(0.0f, 0.0f);
	Positions[CMenuBackground::POS_SETTINGS_PROFILES] = vec2(0.0f, 0.0f);
	Positions[CMenuBackground::POS_SETTINGS_CONFIGS] = vec2(0.0f, 0.0f);
