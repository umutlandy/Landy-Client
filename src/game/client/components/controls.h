...
public:
	...
	// Landy: tracks last pressed direction key (-1=Left, 1=Right, 0=none) per dummy
	// Used by Precision Input to resolve simultaneous left+right key presses
	int m_aLastPressedDirection[NUM_DUMMIES] = {0, 0};
