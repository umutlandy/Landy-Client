...
void CPlayers::RenderHook(
	...
	float Intra)
{
	// Fast input can start or stop a hook between the two predicted render
	// states. Keep rendering while either state still has an active hook so the
	// hook does not disappear for a frame at the transition.
