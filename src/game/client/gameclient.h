...
public:
	...
	public:
		...
		// Landy Fast Input rendering states
		vec2 m_LandyFastRenderPos;
		bool m_LandyFastRenderPosValid;
		int m_LandyFastInteractionState;
		float m_LandyFastSaveWindow;
		int m_LandyFastLastFreezeTime;
		vec2 m_LandyFastLastVel;
		bool m_LandyFastLastVelValid;

		void ResetLandyRenderState();
		void UpdateSkinInfo();
	...
	float GetLandyFastInputOffsetTicks(int ClientId) const;
	int GetLandyFastInputTicks(int ClientId, float OffsetTicks) const;
