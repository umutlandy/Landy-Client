...
if(NOT SPIRV_OPTIMIZER_PROGRAM)
  ...
  if(NOT SPIRV_OPTIMIZER_PROGRAM_FOUND)
    message(STATUS "spirv-opt was not found, Vulkan shaders will be built without optimization.")
  endif()
endif()
...
function(generate_shader_file FILE_ARGS1 FILE_ARGS2 FILE_NAME FILE_OUTPUT_NAME)
  if(SPIRV_OPTIMIZER_PROGRAM_FOUND)
    ...
    list(APPEND GLSLANG_VALIDATOR_COMMAND_LIST COMMAND ${GLSLANG_VALIDATOR_PROGRAM} --client ${TW_VULKAN_VERSION} ${FILE_ARGS1} ${FILE_ARGS2} ${FILE_NAME} -o "${PROJECT_BINARY_DIR}/${FILE_OUTPUT_NAME}")
  endif()
